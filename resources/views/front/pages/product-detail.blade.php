                                                                        ...
                                                                        <div class="small text-muted">
                                                                            <nav aria-label="breadcrumb">
                                                                                <ol class="breadcrumb custom-breadcrumb mb-0">
                                                                                    ...
                                                                                    <li class="breadcrumb-item">
                                                                                        <a href="{{ route('category.products',['slug'=> $product->category->slug]) }}">{{ $product->category->ProductCategory_Name }}</a>
                                                                                    </li>
                                                                        ...
                                                                        <div class="row g-1 align-items-start">
                                                                            <div class="col-lg-5">
                                                                                <div class="main-product-img position-relative">
                                                                                    <img src="{{ $product->thum_image ? $softUrl . $product->thum_image : asset('assets/images/product_default.png')  }}" id="mainProductImage" class="img-fluid product-img"
                                                                                        alt="{{ $product->Product_Name }}">
                                                                                </div>
                                                                                <div class="thumb-slider mt-4">
                                                                                    <div>
                                                                                        <img src="{{ $product->thum_image ? $softUrl . $product->thum_image : asset('assets/images/product_default.png')   }}" class="thumb-img"
