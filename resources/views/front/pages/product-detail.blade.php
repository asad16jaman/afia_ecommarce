                                ...
                                <div class="small text-muted">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb custom-breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a
                                                    href="{{ route('category.products', ['slug' => $product->category->slug]) }}">{{ $product->category->ProductCategory_Name }}
                                                </a>
                                            </li>
                                ...
                                <div class="row g-1 align-items-start">
                                    <div class="col-lg-5">
                                        <div class="main-product-img position-relative">
                                            {{-- <img src="{{ $product->thum_image ? $softUrl . $product->thum_image : asset('assets/images/product_default.png')  }}"
                                                id="mainProductImage" class="img-fluid product-img" alt="{{ $product->Product_Name }}"> --}}

                                            @if($product->product_images->isNotEmpty() && $product->product_images->first()->image)
                                                <img src="{{ $softUrl . $product->product_images->first()->image }}"
                                                    id="mainProductImage" class="img-fluid product-img" alt="{{ $product->Product_Name }}">
                                            @else
                                        ...
                                        <div class="swiper thumb-slider mt-4">
                                            <div class="swiper-wrapper">
                                                {{-- <div class="swiper-slide">
                                                    <img src="{{ $product->thum_image
                                                                                            ? $softUrl . $product->thum_image
                                                                                            : asset('assets/images/product_default.png') }}" class="thumb-img"
                                                        data-img="{{ $product->thum_image
                                                                                            ? $softUrl . $product->thum_image
                                                                                            : asset('assets/images/product_default.png') }}">
                                                </div> --}}
                                    ...
                                    <div class="col-lg-7">
                                        <div class="ms-lg-4">
                                            ...
                                            @else
                                                <div class="" id="selected_product_size" data-selectedid="0" data-selected_size_name="0">
                                                </div>
                                            @endif
