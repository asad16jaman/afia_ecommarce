<!-- <div class="product-card ">
    ...
    <div class="product-content text-center">
        ...
        <div class="d-flex flex-column flex-lg-row justify-content-around mt-2">
            <a href="javascript:void(0)" class="addToCart_css" data-product='@json($ob)' onclick="openProductSizeSelector(event,'add_to_cart')"><i class="bi bi-cart-plus"></i> Add To Cart</a>
            <a href="javascript:void(0)" class="buyNow_css" data-product='@json($ob)' onclick="openProductSizeSelector(event,'buy_now')"><i class="bi bi-bag-check"></i> By Now</a>
        </div>
    </div>
    ...
    <div class="product-size-overlay">
       ...
       <button type="button" class="size-proceed-btn proceed-add-to-cart" onclick="proceedProductSize(event)" >
        ...
        <button type="button" class="size-proceed-btn proceed-buy-now" onclick="proceedProductSizeByNow({{ $ob }},event)" >
...
<div class="product-card ">
    ...
    <div class="product-content text-center data_container" data-thiscard='@json($currentProduct)'>
        ...
        <div class="d-flex flex-column flex-lg-row justify-content-around mt-2">
            ...
            <a href="javascript:void(0)" class="buyNow_css" 
